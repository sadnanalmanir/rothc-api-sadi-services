...
public class FetchRothcMonthlyDataDpmRpmParamsTest extends TestCase {
    ...
    public void testEnsureThatDpmRpmValueEquals144() throws Exception {
        ...
        if (responseEntity != null) {
            try {
                ...
                for (JsonElement environmentDataElement : environmentDataArray) {
                    ...
                    assertEquals(1.44, dpmRpmVal, 0.001f);
                }
