...
public class FetchRothcInputIomParamsTest extends TestCase {
    ...
    public void testEnsureThatIomValueEquals30041() throws Exception {
        ...
        if (responseEntity != null) {
            try {
                ...
                assertEquals(3.0041, iomVal, 0.00001f);
