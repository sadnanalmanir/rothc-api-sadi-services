...
public class FetchRothcMonthlyDataEvapParamsTest extends TestCase {
    ...
    public void testEnsureThatMaxEvapValueEquals95803215() throws Exception {
        ...
        if (responseEntity != null) {
            try {
                ...
                for (JsonElement environmentDataElement : environmentDataArray) {
                    ...
                    assertEquals(95.803215, evapVal, 78f);
                }
    ...
    public void testEnsureThatMinEvapValueEquals18192999() throws Exception {
        ...
        if (responseEntity != null) {
            try {
                ...
                for (JsonElement environmentDataElement : environmentDataArray) {
                    JsonObject envJsonObject = environmentDataElement.getAsJsonObject();
                    float evapVal = envJsonObject.get("Evap").getAsFloat();
                    assertEquals(18.192999, evapVal, 78f);
                }
            } catch (IOException ex) {
                throw new RuntimeException(ex);
            }
