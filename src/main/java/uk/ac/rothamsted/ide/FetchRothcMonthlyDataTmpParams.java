...
@Name("fetchRothcMonthlyDataTmpParams")
...
@InputClass("http://localhost:8080/ontology/service-ontology/fetchRothcMonthlyDataTmpParams.owl#Input")
@OutputClass("http://localhost:8080/ontology/service-ontology/fetchRothcMonthlyDataTmpParams.owl#Output")
public class FetchRothcMonthlyDataTmpParams extends SimpleSynchronousServiceServlet {
    private static final Logger log = Logger.getLogger(FetchRothcMonthlyDataTmpParams.class);
    ...
    public void processInput(Resource input, Resource output) {
        ...
        try (InputStream is = FetchRothcMonthlyDataTmpParams.class.getClassLoader().getResourceAsStream("rothc-api-access.properties")) {
        ...
        log.info("Invoking SADI service:  fetchRothcMonthlyDataTmpParams");
