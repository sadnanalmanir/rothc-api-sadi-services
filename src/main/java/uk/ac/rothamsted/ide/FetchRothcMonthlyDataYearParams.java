...
@Name("fetchRothcMonthlyDataYearParams")
...
@InputClass("http://localhost:8080/ontology/service-ontology/fetchRothcMonthlyDataYearParams.owl#Input")
@OutputClass("http://localhost:8080/ontology/service-ontology/fetchRothcMonthlyDataYearParams.owl#Output")
public class FetchRothcMonthlyDataYearParams extends SimpleSynchronousServiceServlet {
    private static final Logger log = Logger.getLogger(FetchRothcMonthlyDataYearParams.class);
    ...
    public void processInput(Resource input, Resource output) {
        ...
        try (InputStream is = FetchRothcMonthlyDataYearParams.class.getClassLoader().getResourceAsStream("rothc-api-access.properties")) {
        ...
        log.info("Invoking SADI service:  fetchRothcMonthlyDataYearParams");
