...
@Name("fetchRothcMonthlyDataDpmRpmParams")
...
@InputClass("http://localhost:8080/ontology/service-ontology/fetchRothcMonthlyDataDpmRpmParams.owl#Input")
@OutputClass("http://localhost:8080/ontology/service-ontology/fetchRothcMonthlyDataDpmRpmParams.owl#Output")
public class FetchRothcMonthlyDataDpmRpmParams extends SimpleSynchronousServiceServlet {
    private static final Logger log = Logger.getLogger(FetchRothcMonthlyDataDpmRpmParams.class);
    ...
    public void processInput(Resource input, Resource output) {
        ...
        try (InputStream is = FetchRothcMonthlyDataDpmRpmParams.class.getClassLoader().getResourceAsStream("rothc-api-access.properties")) {
        ...
        log.info("Invoking SADI service:  fetchRothcMonthlyDataDpmRpmParams");
