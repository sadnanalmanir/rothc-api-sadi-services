...
@Name("fetchRothcMonthlyDataRainParams")
...
@InputClass("http://localhost:8080/ontology/service-ontology/fetchRothcMonthlyDataRainParams.owl#Input")
@OutputClass("http://localhost:8080/ontology/service-ontology/fetchRothcMonthlyDataRainParams.owl#Output")
public class FetchRothcMonthlyDataRainParams extends SimpleSynchronousServiceServlet {
    private static final Logger log = Logger.getLogger(FetchRothcMonthlyDataRainParams.class);
    ...
    public void processInput(Resource input, Resource output) {
        ...
        try (InputStream is = FetchRothcMonthlyDataRainParams.class.getClassLoader().getResourceAsStream("rothc-api-access.properties")) {
        ...
        log.info("Invoking SADI service:  fetchRothcMonthlyDataRainParams");
