...
@InputClass("http://localhost:8080/ontology/service-ontology/fetchRothcInputClayParams.owl#Input")
@OutputClass("http://localhost:8080/ontology/service-ontology/fetchRothcInputClayParams.owl#Output")
public class FetchRothcInputClayParams extends SimpleSynchronousServiceServlet {
    private static final Logger log = Logger.getLogger(FetchRothcInputClayParams.class);
