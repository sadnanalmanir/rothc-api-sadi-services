...
@Name("fetchRothcInputNstepsParams")
...
@InputClass("http://localhost:8080/ontology/service-ontology/fetchRothcInputNstepsParams.owl#Input")
@OutputClass("http://localhost:8080/ontology/service-ontology/fetchRothcInputNstepsParams.owl#Output")
public class FetchRothcInputNstepsParams extends SimpleSynchronousServiceServlet {
    private static final Logger log = Logger.getLogger(FetchRothcInputNstepsParams.class);
