...
@Name("fetchRothcMonthlyDataMonthParams")
...
@InputClass("http://localhost:8080/ontology/service-ontology/fetchRothcMonthlyDataMonthParams.owl#Input")
@OutputClass("http://localhost:8080/ontology/service-ontology/fetchRothcMonthlyDataMonthParams.owl#Output")
public class FetchRothcMonthlyDataMonthParams extends SimpleSynchronousServiceServlet {
    private static final Logger log = Logger.getLogger(FetchRothcMonthlyDataMonthParams.class);
    ...
    public void processInput(Resource input, Resource output) {
        ...
        try (InputStream is = FetchRothcMonthlyDataMonthParams.class.getClassLoader().getResourceAsStream("rothc-api-access.properties")) {
        ...
        log.info("Invoking SADI service:  fetchRothcMonthlyDataMonthParams");
